...
export interface ApiFieldField extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    night_price: Schema.Attribute.Decimal;
    ...
    >;
    schedule: Schema.Attribute.Component<'field-schedule.schedule', true>;
    sport: Schema.Attribute.Enumeration<['Futbol', 'Tenis', 'Basket']> &
      Schema.Attribute.Required;
    sport_center: Schema.Attribute.Relation<
      'manyToOne',
      'api::sport-center.sport-center'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiReservationReservation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    payment_metadata: Schema.Attribute.JSON;
    payment_method: Schema.Attribute.Enumeration<
      ['Paypal', 'Mercado Pago', 'Stripe', 'Yape']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Yape'>;
    payment_status: Schema.Attribute.Enumeration<
      ['Pagado', 'Pendiente', 'Cancelado', 'Parcialmente Pagado']
    > &
      Schema.Attribute.Required &
...
export interface ApiSportCenterSportCenter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
    district: Schema.Attribute.Enumeration<['Surco', 'San Isidro', 'Molina']> &
      Schema.Attribute.Required;
    email: Schema.Attribute.Email;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    sport_centers: Schema.Attribute.Relation<
      'oneToMany',
      'api::sport-center.sport-center'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::sport-center.sport-center': ApiSportCenterSportCenter;
